...
class SkillManager:
    ...
    def list_skill_files(self, skill: SkillInfo) -> tuple[list[str], list[str]]:
        ...
        # Optimization: use os.walk instead of rglob for faster string-path generation.
        # It avoids the overhead of instantiating heavy Path objects during traversal.
