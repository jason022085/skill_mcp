...
class SkillScanner:
    ...
    def _is_excluded(self, path: Path) -> bool:
        ...
        """
        # ⚡ Bolt Optimization: Replace O(N*M) string substring checks
        # with an O(1) set intersection check. This also avoids issues
        # with relative paths missing leading slashes.
