...
class SkillScanner:
    ...
    def _is_excluded(self, path: Path) -> bool:
        ...
        """
        # Optimize: use set intersection check over string conversion and substring checks
        # O(1) checks per part vs O(n) string searching, and handles relative paths better.
