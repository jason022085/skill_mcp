...
class SkillScanner:
    ...
    def _is_excluded(self, path: Path) -> bool:
        ...
        """
        # PERFORMANCE: Use O(1) set intersection for single-level directories
        # instead of O(N*M) string matching.
        ...
        # Fallback for complex multi-segment exclusions (e.g., 'env/lib')
        path_str = str(path)
