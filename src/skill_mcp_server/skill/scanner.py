...
class SkillScanner:
    ...
    def _is_excluded(self, path: Path) -> bool:
        ...
        """
        # Optimize: Iterate over parts directly instead of string conversion and substring checks.
        # This avoids expensive substring checks and handles cross-platform paths natively.
        return any(
            part in self.EXCLUDED_DIRS or (part.startswith(".") and part not in (".", ".."))
